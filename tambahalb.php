...
<html lang="en">
  ...
  <body>
    ...
    <form action="simpanalb.php" method="POST">
    <div class="container mt-3">
      <div class="row">
          <div class="card">
          <div class="mb-3">
            <label for="" class="form-label">Nama Album</label>
            <input type="hidden" class="form-control" name="albumid" placeholder="">
            <input type="text" class="form-control" name="namaalbum" placeholder="">
          </div>
          <div class="mb-3">
